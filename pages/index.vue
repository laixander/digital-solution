...
<script setup>
import { ChevronDown, ChevronUp, House, Users, UserCog, Briefcase, CalendarDays, BookOpen, Search, Command, Plus, Bell, Activity, CloudDownload, ShoppingBag } from 'lucide-vue-next';
</script>