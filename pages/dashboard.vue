...
<script setup>
    ...
    import { SearchIcon, PlusIcon, CreditCardIcon, TableIcon, XIcon, ChevronDownIcon, ChevronUpIcon, HouseIcon, UsersIcon, UserCogIcon, BriefcaseIcon, CalendarDaysIcon, BookOpenIcon, } from 'lucide-vue-next';
